...
impl ModelResource for ExerciseInstructionResource {
    ...
    async fn default(instruction: ExerciseInstruction, database: &DatabaseManager) -> Self {
        Self {
    ...
    async fn simple(instruction: ExerciseInstruction, database: &DatabaseManager) -> Self {
        Self {
            content: instruction.content,
            sequence_number: instruction.sequence_number,
        }
