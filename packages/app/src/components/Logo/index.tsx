...
const Logo: Component<{
    ...
    <div
        classList={{
            [styles.logo]: true,
            [styles.logoDark]: props.theme === 'dark',
            [styles.logoLight]: props.theme === 'light',
        }}
    >
        <svg
            id="logo"
            width={props.showText ? '108' : '38'}
            height="38"
            viewBox={`0 0 ${props.showText ? '108' : '38'} 38`}
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
        >
            <path
                classList={{
                    [styles.logoText]: true,
                    [styles.logoTextVisible]: props.showText,
                    [styles.logoTextInvisible]: !props.showText,
                }}
                fill="black"
            ...
            <g clip-path="url(#clip0_166_279)">
                <g clip-path="url(#clip1_166_279)">
                    <path d="M4.17004 25.0094L5.65305 24.4085" stroke="#4CF0C4" stroke-width="2.3042" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M8.34947 18.2806L5.38346 19.4825C4.99014 19.6418 4.65909 19.9086 4.46314 20.2241C4.2672 20.5396 4.2224 20.8779 4.3386 21.1647L6.96749 27.6523C7.08369 27.939 7.35138 28.1507 7.71167 28.2408C8.07195 28.3309 8.49532 28.292 8.88864 28.1326L11.8547 26.9307" stroke="#4CF0C4" stroke-width="2.3042" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M7.91123 17.1993L12.2927 28.012C12.4089 28.2987 12.6766 28.5104 13.0369 28.6005C13.3972 28.6906 13.8205 28.6517 14.2139 28.4923L15.6969 27.8914C16.0902 27.732 16.4212 27.4652 16.6172 27.1497C16.8131 26.8343 16.8579 26.4959 16.7417 26.2091L12.3602 15.3965C12.244 15.1097 11.9764 14.898 11.6161 14.8079C11.2558 14.7178 10.8324 14.7568 10.4391 14.9162L8.95609 15.5171C8.56277 15.6765 8.23173 15.9432 8.03578 16.2587C7.83983 16.5742 7.79503 16.9125 7.91123 17.1993Z" stroke="#4CF0C4" stroke-width="2.3042" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M14.551 20.8028L23.4491 17.1972" stroke="#4CF0C4" stroke-width="2.3042" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M26.1454 11.0693L29.1115 9.86743C29.5048 9.70805 29.9281 9.66912 30.2884 9.7592C30.6487 9.84928 30.9164 10.061 31.0326 10.3478L33.6615 16.8354C33.7777 17.1221 33.7329 17.4605 33.537 17.7759C33.341 18.0914 33.01 18.3582 32.6166 18.5176L29.6506 19.7194" stroke="#4CF0C4" stroke-width="2.3042" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M21.2583 11.7909L25.6398 22.6035C25.756 22.8903 26.0237 23.102 26.3839 23.1921C26.7442 23.2822 27.1676 23.2432 27.5609 23.0838L29.0439 22.4829C29.4372 22.3235 29.7683 22.0568 29.9642 21.7413C30.1602 21.4258 30.205 21.0875 30.0888 20.8007L25.7073 9.98803C25.5911 9.70126 25.3234 9.48955 24.9631 9.39947C24.6028 9.30939 24.1795 9.34833 23.7861 9.50771L22.3031 10.1086C21.9098 10.268 21.5788 10.5348 21.3828 10.8503C21.1869 11.1657 21.1421 11.5041 21.2583 11.7909Z" stroke="#4CF0C4" stroke-width="2.3042" stroke-linecap="round" stroke-linejoin="round"/>
                    <path d="M33.8301 12.9906L32.347 13.5915" stroke="#4CF0C4" stroke-width="2.3042" stroke-linecap="round" stroke-linejoin="round"/>
                </g>
            </g>
            <defs>
                <clipPath id="clip0_166_279">
                    <rect width="36" height="28" fill="white" transform="translate(1 5)"/>
                </clipPath>
                <clipPath id="clip1_166_279">
                    <rect width="38.4033" height="28" fill="white" transform="translate(-4.05383 13.2361) rotate(-22.0586)"/>
                </clipPath>
            </defs>
        </svg>

        <Show when={props.tagLabel} keyed>
            {tagLabel => (
                <>
                    <Transition
                        show={props.showText}
                        ...
                        leaveTo="opacity-0 -translate-x-full hidden"
                    >
                        <div class="flex items-center">
                            <div class={styles.logoTag}>
                                <span>
                    ...
                    <Transition
                        ...
                        leaveTo="opacity-0 -translate-y-full hidden"
                    >
                        <div class="absolute -bottom-1 left-1/2 -translate-x-1/2 translate-y-[110%]">
                            <div class={styles.logoTag}>
                                <span>
                                    {tagLabel.toUpperCase()}
                                </span>
